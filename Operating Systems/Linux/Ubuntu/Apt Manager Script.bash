...
function aptManagerDistUpgrade {
    echo -e $'\nApt Manager Dist Upgrade Start!';
    echo -e $1 | sudo -S apt dist-upgrade -y;
    echo -e $'Apt Manager Dist Upgrade Finish!\n';
}
...
aptManagerDistUpgrade $password;
